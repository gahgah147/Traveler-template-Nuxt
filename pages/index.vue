<template>
  <div class="home-container">
      ...
      <div class="home-main">
        ...
        <div class="home-content">
          <header data-thq="thq-navbar" class="home-navbar">
            <img alt="logo" src="/logo.svg" class="home-logo" />
            ...
            <div data-thq="thq-mobile-menu" class="home-mobile-menu">
              ...
              >
                <div class="home-container1">
                  <img alt="logo" src="/logo.svg" class="home-logo1" />
          ...
          <div class="home-center">
            ...
            <div class="home-border">
              <div class="home-filter">
                <img alt="image" src="/Icons/location.svg" class="home-image" />
                <input
                  type="text"
                ...
                <div class="home-search">
                  <img alt="image" src="/Icons/search.svg" class="home-icon10" />
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="tours" class="home-quick-view">
      ...
      <div class="home-offers">
        <nuxt-link to="/">
          <div class="home-offer-container">
            <app-offer Image="/Offers/offers-11-1500w.png"></app-offer>
          </div>
        </nuxt-link>
        <nuxt-link to="/">
      ...
      <div class="home-pagination">
        ...
        <div class="home-pages">
          ...
          <img alt="image" src="/Icons/more.svg" class="home-more" />
      ...
      <div class="home-content02">
        ...
        <div class="home-details">
          <div class="home-author">
            <img alt="image" src="/Avatar/quote-200h.png" class="home-avatar" />
    ...
    <section id="destinations" class="home-destinations">
      <div class="home-video-details">
        ...
        <div class="home-video-wrapper">
          <div class="home-tint1">
            <img alt="image" src="/Icons/play.svg" class="home-image5" />
          </div>
          <video
            src
      ...
      <div class="home-list">
        <nuxt-link to="/" class="home-navlink09">
          <div class="home-location-wrapper"><app-location></app-location></div>
        </nuxt-link>
        <nuxt-link to="/" class="home-navlink10">
        ...
        <nuxt-link to="/" class="home-navlink11">
        ...
        <nuxt-link to="/" class="home-navlink12">
        ...
        <div class="home-main2">
          <div class="home-branding">
            <div class="home-heading10">
              <img alt="image" src="/logo.svg" class="home-image6" />
